...
sudo apt install -y texinfo gengetopt
sudo apt install -y libexpat1-dev libusb-dev libncurses5-dev cmake
# deps for poky
sudo apt install -y python3 patch diffstat texi2html texinfo subversion chrpath git wget
# deps for qemu
sudo apt install -y libgtk-3-dev
# deps for firemarshal
sudo apt install -y python3-pip python3-dev rsync libguestfs-tools expat
# install DTC
...
sudo apt install -y binutils-riscv64-unknown-elf gcc-riscv64-unknown-elf
